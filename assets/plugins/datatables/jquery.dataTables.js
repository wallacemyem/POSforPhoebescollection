...
(/** @lends <global> */function( $ ) {
	 ...
	 *  @param {object} settings DataTables settings object
	 *  @param {string|int} Actions Paging Actions to take: "first", "previous",
	 *    "next" or "last" or page number to jump to (integer)
	 *  @param [bool] redraw Automatically draw the update or not
	 *  @returns {bool} true page has changed, false - no change
	 *  @memberof DataTable#oApi
	 */
	function _fnPageChange ( settings, Actions, redraw )
	{
		var
			start     = settings._iDisplayStart,
			len       = settings._iDisplayLength,
		...
		{
			_fnLog( settings, 0, "Unknown paging Actions: "+Actions, 5 );
		}
	 ...
	 * @returns {DataTables.Api} this
	 */
	_api_register( 'page()', function ( Actions ) {
		...
		return this.iterator( 'table', function ( settings ) {
			_fnPageChange( settings, Actions );
		} );
	} );
	 ...
	 *    are applied.
	 */
	_api_register( 'page.info()', function ( Actions ) {
			...
			_: function ( settings, host, idx, buttons, page, pages ) {
				...
				var attach = function( container, buttons ) {
					...
					var clickHandler = function ( e ) {
						_fnPageChange( settings, e.data.Actions, true );
					};
					...
					for ( i=0, ien=buttons.length ; i<ien ; i++ ) {
						...
						if ( $.isArray( button ) ) {
							...
							if ( btnDisplay ) {
								...
								_fnBindAction(
									node, {Actions: button}, clickHandler
								);
