<div class="row">
    <div class="col-md-12 ">
        ...
        <div class="col-md-12">
<<<<<<< HEAD
            <?php $data=array( 'class'=>'btn btn-info btn-outline-primary pull-right','name'=>'searchecord','value'=>'Search invoices'); echo form_submit($data); ?>
=======
            <?php $data=array( 'class'=>'btn btn-info btn-outline-secondarypull-right','name'=>'searchecord','value'=>'Search invoices'); echo form_submit($data); ?>
...
<div class="row">
    <div class="col-md-12 ">
        <h4 class="text-left" style="margin-left:2%;"><i class="fa fa-hand-o-right" aria-hidden="true"></i> View invoices</h4>
    </div>
