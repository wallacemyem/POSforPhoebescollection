                                        ...
                                        <td>
                                            <div class="btn-group pull no-print pull-right">
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    <li onclick="show_modal_page('<?php echo base_url().'customers/popup/edit_customer_payment_model/'.$single_customer->id; ?>')" ><a href="#"><i class="fa fa-pencil"></i> View Edit Details</a>
                                                    </li>
