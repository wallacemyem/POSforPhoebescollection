                ...
                <div class="box-body" id="print-section">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group col-md-3" style="margin-top:26px;">
                            <?php
                                $data = array('class'=>'btn btn-info  btn-outline-primary input-lg','type' => 'submit','name'=>'btnSubmit','value'=>'true', 'content' => '<i class="fa fa-search" aria-hidden="true"></i> Search returns');
