                                    ...
                                    <td>
                                        <div class="btn-group pull no-print pull-right">
                                            ...
                                            <ul class="dropdown-menu" role="menu">
                                                ...
                                                <li><a onclick="confirmation_alert('delete this  ','<?php echo base_url().'initilization/delete/brandSector/'.$single_brand->id; ?>')" href="javascript:void(0)" > <i class="fa fa-trash-o"></i> Delete</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </td>
