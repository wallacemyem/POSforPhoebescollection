                            ...
                            <tbody>
                                <?php
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo $single_list->description; ?>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="btn-group no-print pull pull-right">
                                                ...
                                                <ul class="dropdown-menu " role="menu">
                                                    ...
                                                    <li  >      
                                                        <a onclick="confirmation_alert('delete this ','<?php echo base_url().'product/delete_stock/'.$single_list->id; ?>')"  href="javascript:void(0)" >       <i class="fa fa-trash"></i>   Delete
                                                        </a>
                                                    </li>
                                                </ul>
                                            </div>
