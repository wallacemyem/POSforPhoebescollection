    ...
    <div class="row">
        <div class="col-md-12">
            <div class="pull pull-right">
                <button class="btn btn-info btn-outline-primary" onclick="show_modal_page('<?php echo base_url().'printer_settings/popup/add_new_printer_model/'; ?>')" ><i class="fa fa-plus-square" aria-hidden="true"></i> Create Printer
                </button>
