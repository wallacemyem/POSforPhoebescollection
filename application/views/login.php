...
<head>
    ...
    <title> Elegant POS-Inventory </title>
...
<body class="hold-transition login-page " style="background-image:url('<?php echo base_url(); ?>uploads/systemimgs/bg-login.png'); background-size:cover; position: relative;">
  ...
  <br/><br/>   
        <h3 class="text-center" style="font-family: cursive;">
            <a href="<?php echo base_url('login'); ?>"> <b style="color:#faffbd;">Elegant POS-Inventory </b></a>
        </h3>
        <div class="login-box-body">
            <p class="login-box-msg" style="color: #fffdfde0;font-size: 18px;">Please enter your Email & Password</p>
            <?php
            ...
            <?php echo form_open('login/authentication',$attributes); ?>
                <div class="form-group has-feedback">
                    <?php
                        $data = array('class'=>'form-control input-lg','id'=>'user_email','type'=>'email','name'=>'user_email','value'=>'','placeholder'=>'Email Address','reqiured'=>'','AUTOCOMPLETE'=>'OFF');
                ...
                <!-- ForgetModel ends-->
                <br />    
                <a style="color: #eee; font-size: 18px;" href="javascript:void(0)" data-toggle="modal" data-target="#ForgetModel" class="pull-left link-set">Forget Password</a>
