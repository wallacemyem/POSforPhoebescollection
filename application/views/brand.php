    ...
    <div class="row">
        <div class="col-md-12">
            <div class="pull pull-right">
                <button class="btn btn-info btn-outline-primary" onclick="show_modal_page('<?php echo base_url().'initilization/popup/add_brand_model/'; ?>')" ><i class="fa fa-plus-square" aria-hidden="true"></i> Create Brand
                </button>
                                        ...
                                        <td>
                                            <div class="btn-group pull no-print pull-right">
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    <li onclick="show_modal_page('<?php echo base_url().'initilization/popup/edit_brand_model/'.$single_brand->id; ?>')" ><a href="#"><i class="fa fa-pencil"></i> View details</a></li>
                                                    <li>
                                                        <a onclick="confirmation_alert('delete this  ','<?php echo base_url().'initilization/delete/brand/'.$single_brand->id; ?>')" href="javascript:void(0)" ><i class="fa fa-trash-o"></i> Delete</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </td>
