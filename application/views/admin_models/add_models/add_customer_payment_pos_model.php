          ...
          <div class="col-md-12">
				...
				<?php echo form_open('customers/add_customer_payments',$attributes); ?>  
		            ...
		            if($customer_list  != NULL)
		            {
			            ...
			            {
			            ?>
			                <option <?php echo ($single_customer->id == $cus_id ? 'selected' :'');  ?> value="<?php echo $single_customer->id; ?>">
		      ...
		      <div class="form-group">    
				<?php
						...
						$data = array('class'=>'form-control input-lg','type'=>'text','name'=>'amount','value'=>$previous_amt,'reqiured'=>'');
						echo form_input($data);							
				?>           
		      </div>
		       	<div class="form-group">
		       		<?php echo form_label('Method'); ?>
