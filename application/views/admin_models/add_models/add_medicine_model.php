			...
			<div class="box-body">	
				<div class="col-md-12">
					...
					<div class="form-group">
						<?php
<<<<<<< HEAD
							$data = array('class'=>'btn btn-info btn-outline-primary','type' => 'submit','name'=>'btn_submit_medicine','value'=>'true', 'content' => '<i class="fa fa-floppy-o" aria-hidden="true"></i> Save Medicine');
=======
							$data = array('class'=>'btn btn-info btn-outline-secondary','type' => 'submit','name'=>'btn_submit_medicine','value'=>'true', 'content' => '<i class="fa fa-floppy-o" aria-hidden="true"></i> Save Medicine');
