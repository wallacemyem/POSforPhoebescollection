		...
		<?php echo form_open('bank/add_bank',$attributes); ?>  
		  ...
		  <div class="form-group">  
  		  ...
  		  <div id="existing_account">	 	  
			  ...
			  <div class="form-group">  				
				<?php
					$data = array('class'=>'btn btn-info btn-outline-primary','type' => 'submit','name'=>'btn_submit_category','value'=>'true', 'content' => '<i class="fa fa-floppy-o" aria-hidden="true"></i> Save Bank');
