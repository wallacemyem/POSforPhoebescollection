...
<div class="modal-body">
   <div class="row">
		   ...
		   <div class="form-group">
			<?php echo form_label('User Email:'); ?>
	           <?php
					...
					$data = array('class'=>'form-control input-lg','type'=>'email','name'=>'user_email','placeholder'=>'e.g Pencil@gmail.com','reqiured'=>'');
					echo form_input($data);
	  ...
	  <div class="form-group">  				
		<?php
			$data = array('class'=>'btn btn-info btn-outline-primary input-lg ','type' => 'submit','name'=>'btn_submit_usertomer','value'=>'true', 'content' => '<i class="fa fa-floppy-o" aria-hidden="true"></i> Save User');
