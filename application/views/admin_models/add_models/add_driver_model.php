          ...
          <div class="col-md-12">
			...
			<?php echo form_open_multipart('supply/add_driver',$attributes); ?>
	          ...
	          <div class="form-group">
	           ...
	           <?php
					$data = array('class'=>'form-control input-lg','type'=>'text','name'=>'reference','placeholder'=>'e.g Pencil');
					echo form_input($data);
				?>
	          </div>
	          <div class="form-group">
			  ...
			  <div class="form-group">  				
				<?php
					$data = array('class'=>'btn btn-info btn-outline-primary margin','type' => 'submit','id'=>'','name'=>'btn_submit_Testamonial','value'=>'true', 'content' => '<i class="fa fa-floppy-o" aria-hidden="true"></i> Save Driver');
