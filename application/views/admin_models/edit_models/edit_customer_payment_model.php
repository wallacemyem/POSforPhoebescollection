	...
	<div class="row">
      <div class="box box-danger">
		...
		<?php echo form_open('customers/edit_customer_payments',$attributes); ?>  
		  ...
		  <div class="form-group">  				
			<?php
				$data = array('class'=>'btn btn-info btn-outline-primary','type' => 'submit','name'=>'btn_submit_category','value'=>'true', 'content' => '<i class="fa fa-floppy-o" aria-hidden="true"></i> Update Payment');
