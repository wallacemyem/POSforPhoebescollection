            ...
            <div  class="box-body">
               ...
               <div  class="col-md-12">
				...
				<?php echo form_open_multipart('users/edit',$Edit_attributes); ?>
				  ...
				  <div class="form-group">  				
					<?php
						$data = array('class'=>'btn btn-info btn-outline-primary ','type' => 'submit','name'=>'btn_submit_usertomer','value'=>'true', 'content' => '<i class="fa fa-floppy-o" aria-hidden="true"></i> Update user');
