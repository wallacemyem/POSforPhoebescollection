    ...
    <div class="row">
        <div class="col-md-12">
            <div class="pull pull-right">
                <button class="btn btn-info btn-outline-primary" onclick="show_modal_page('<?php echo base_url().'initilization/popup/add_region_model/'; ?>')" ><i class="fa fa-plus-square" aria-hidden="true"></i> 
                    Create Region
                </button>
                <button type="button" onclick="show_modal_page('<?php echo base_url();?>initilization/popup/add_csv_model/region')" class="btn btn-success btn-outline-primary ">
                    <i class="fa fa-upload" aria-hidden="true"></i>
                    Upload CSV
                </button>
                <a href="<?php echo base_url('initilization/export/region'); ?>" class="btn btn-primary btn-outline-primary ">
