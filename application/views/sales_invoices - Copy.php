<div class="row">
    <div class="col-md-12 ">
        ...
        <?php echo form_open('invoice/manage',$attributes); ?>
            ...
            <div class="col-md-12">
                <?php
                    $data = array('class'=>'btn btn-info btn-outline-secondary margin  pull-right','type' => 'submit','name'=>'searchecord','value'=>'true', 'content' => '<i class="fa fa-search" aria-hidden="true"></i> Search receipts');
                    ...
                    <tr  style="border-bottom: 2px dotted #eee;">
                        ...
                        <b>  Payment Method: </b>
                            ...
                            else if($invoices_Record[$i]->payment_method == 2)
                            {
                             ...
                             <b> Cash recieved:</b> <?php echo $invoices_Record[$i]->bill_paid; ?> /- ] [ <b>  Cash balance:</b> <?php echo $invoices_Record[$i]->total_bill-$invoices_Record[$i]->bill_paid; ?> /- ]
                        </td>
                    </tr>
                    </table>                    
                </div>
